...
static NSString * const HTCustomURLProtocolHandledKey = @"HTCustomURLProtocolHandledKey2";

@interface CustomURLProtocol2 ()
...
@implementation CustomURLProtocol2

+ (BOOL)canInitWithRequest:(NSURLRequest *)request {
//    NSLog(@"protocol2 --- %s  requestInfo --- %@",__FUNCTION__, request.description);
